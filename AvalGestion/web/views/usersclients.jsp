                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-footer">
                                        <div class="pull-right">
                                            <a href="gd_usuarioSRV?action=signoff" class="btn btn-default btn-flat">Cerrar Session</a>
                                        </div>
                                    </li>
                                </ul>
                            </li>
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0">Usuario - Clientes</h1>
                            </div><!-- /.col -->
                            <div class="col-sm-6">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <!--<div class="card-header">
                                        <a href="apr_clienteSRV?accion=nuevo" class="btn btn-success disabled">
                                            <i class="fa fa-plus"></i> Nueva Configuración 
                                        </a>
                                    </div>-->
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                        <table id="tablaUsuarioClientes" class="table table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    <th>IDUsuario</th>
                                                    <th>Usuario</th>
                                            ...
                                            <c:forEach var="gd_usuariosCli" items="${gd_usuariosCli}" varStatus="iteracion">                                                    
                                                <tr>
                                                    <td>${gd_usuariosCli.idUsuario}</td>
                                                    <td>${gd_usuariosCli.nombreUsuario}</td>
