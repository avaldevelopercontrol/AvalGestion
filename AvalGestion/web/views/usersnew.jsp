    ...
    <body class="hold-transition sidebar-mini layout-fixed">
        <div class="wrapper">
            ...
            <div class="preloader flex-column justify-content-center align-items-center">
                <img class="animation__shake" src="dist/img/aval_logo.jpg" alt="AvalPeruLogo" height="60" width="60">
            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="card card-info">
                                    <div class="card-body">
                                        <form class="form-horizontal" action="gd_usuarioSRV?action=registeruser" method="post">
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input id="idUsuario" type="text" class="form-control form-control-sm" placeholder="Id Usuario" 
                                                               readonly="true" name="txtidUsuario" maxlength="10">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input id="nombres" type="text" class="form-control form-control-sm" placeholder="Nombres de Usuario" 
                                                               name="txtnombres" maxlength="350" required>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input id="apellidos" type="text" class="form-control form-control-sm" placeholder="Apellidos de Usuario" 
                                                               name="txtapellidos" maxlength="350" required>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="input-group mb-12">
                                                        ...
                                                        <input id="nombreUsuario" type="text" class="form-control form-control-sm" placeholder="Nombre Usuario" 
                                                               name="txtnombreUsuario" maxlength="350" required>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="input-group mb-12">
                                                        ...
                                                        <input id="nombreUsuario" type="password" class="form-control form-control-sm" placeholder="Clave Usuario" 
                                                               name="txtclaveUsuario" maxlength="350" required>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="input-group mb-3">
                                                    <div class="col-sm-offset-2 col-sm-10">
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" name="chkactivo" id="chkactivo" checked=""> Activo
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="card-footer">
                                                ...
                                                <button type="submit" id="btnRegistrar" name="btnRegistrar" value="Registrar" class="btn btn-success"><i class="fa fa-floppy-o"></i> Registrar</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
