        ...
        <div class="wrapper">
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                ...
                <a href="#" class="brand-link">
                    <img src="dist/img/aval_logo.jpg" alt="Aval Gestión" class="brand-image img-circle elevation-3" style="opacity: .8">
                        ...
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item menu-open">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="av_clienteSRV?action=listarClientes" class="nav-link">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <a href="gd_usuarioSRV?action=newuser" class="btn btn-success">
                                    ...
                                    <div class="card-body">
                                        <table id="tablaUsuarios" class="table table-bordered table-hover">
                                            ...
                                            <c:forEach var="usuario" items="${gd_usuario}" varStatus="iteracion">
                                                <tr>
                                                    ...
                                                    <c:if test="${usuario.esRoot == true}">
                                                        <td><span class="badge bg-green active">Es Root</span></td> 
                                                    </c:if>
                                                    <c:if test="${usuario.esRoot == false}">
                                                        <td><span class="badge bg-red active">No es Root</span></td> 
                                                    </c:if>
                                                    <td>
                                                        <a href="<c:url value="gd_usuarioSRV">
                                                            <c:param name="action" value="getuser" />
                                                            <c:param name="idUsuario" value="${usuario.idUsuario}" />
                                                            </c:url>"><button type="button" class="btn btn-warning btn-xs" data-toggle="tooltip"  title="Editar" data-original-title="Editar">
